resource "azurerm_windows_web_app" "this" {
  ...
  lifecycle {
    ignore_changes = [
      ...
      app_settings["AzureTable:AccountKey"],
      app_settings["AzureTable:AccountName"],
      app_settings["AzureTable:PrimaryEndpoint"],
      app_settings["AzureTable:TableName"],
      app_settings["AzureTableAccountKeyapp03"],
      app_settings["ContactAPI:EnableC360Logging"],
      app_settings["ContactAPI:EnableVerboseLogging"],
      app_settings["ContactAPI:Host"],
      app_settings["ContactAPI:HttpClientTimeout"],
      app_settings["ContactAPI:ResilienceMaxRetries"],
      app_settings["ContactAPI:ResilienceTimeout"],
      app_settings["IdentityAPI:APIKey"],
      app_settings["IdentityAPI:ContactCreateOriginIDPrefix"],
      app_settings["IdentityAPI:EnableAPIKey"],
      app_settings["IdentityAPI:EnablePayloadLogging"],
      app_settings["IdentityAPI:IPCodePrefix"],
      app_settings["ServiceBusConnectionString"],
      app_settings["TableName"],
      app_settings["TableStoragePrimaryEndpoint"],
      app_settings["WEBSITES_ENABLE_APP_SERVICE_STORAGE"],
      app_settings["WEBSITE_USE_PLACEHOLDER"],
      app_settings["scm_type"],
      app_settings["Databases:OrderMaster:CommandTimeoutSeconds"],
      app_settings["Databases:OrderMaster:ConnectionString"],
      app_settings["OrderAPI:APIKey"],
      app_settings["OrderAPI:EnableAPIKey"],
      app_settings["OrderAPI:EnablePayloadLogging"],
      app_settings["OrderAPI:Orders:SQLSPGetOrderDetails"],
      app_settings["OrderAPI:Orders:SQLSPGetOrderDetailsDefaultSizePagination"],
      app_settings["OrderAPI:Orders:SQLSPGetOrderDetailsMaxSizePagination"],
      app_settings["OrderAPI:Orders:SQLSPGetOrderDetailsMinSizePagination"],
      app_settings["OrderAPI:Orders:SQLSPGetOrders"],
      app_settings["OrderAPI:Orders:SQLSPGetOrdersDefaultSizePagination"],
      app_settings["OrderAPI:Orders:SQLSPGetOrdersMaxSizePagination"],
      app_settings["OrderAPI:Orders:SQLSPGetOrdersMinSizePagination"],
      app_settings["OrderAPI:Orders:SQLSPUpsertOrderDetails"],
      app_settings["OrderAPI:References:SQLSPUpsertReferenceContacts"],
      app_settings["OrderAPI:References:SQLSPUpsertReferenceProducts"],
